...
async def send_product_list(call: CallbackQuery):
    await call.answer()
...
async def handle_product_details_button(call: CallbackQuery, callback_data: ProductCbData):
    await call.answer()
...
async def handle_product_update_button(call: CallbackQuery, callback_data: ProductCbData):
    await call.answer()
...
async def handle_product_delete_button(call: CallbackQuery, callback_data: ProductCbData):
    await call.answer(
